...
let superheroJSON = [{
  ...
  "picture":"assets/images/CaptainAmerica.jpg",
...
function App() {
  return (
        ...
        <div className="App">
          <h1 className="header">Superheroes: Overview</h1>
                     {
              superheroJSON.map((Superhero) => 
                  <DescriptionCard picture={Superhero.picture} name={Superhero.name}  universe={Superhero.universe} alterEgo={Superhero.alterEgo}  
                  occupation={Superhero.occupation}  friends={Superhero.friends} superPowers={Superhero.superPowers} info={Superhero.info}></DescriptionCard>
              )
            }
                 </div>
